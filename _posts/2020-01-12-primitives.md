...
author: jaksa
categories: [ java, tutorial, data types, primitive ]
image: assets/images/13.jpg
---

# Primitive Data Types in Java

[Source](https://howtodoinjava.com/java/basics/primitive-data-types-in-java/ "Permalink to Primitive Data Types in Java")

Learn about all **eight primitive data types in Java**, their memory sizes, default values, and range of the maximum and the minimum value.

Primitive [data types](https://howtodoinjava.com/java/basics/data-types-in-java/) are predefined by the Java Language and named by a [reserved keyword](https://howtodoinjava.com/java-keywords/). Let’s look at each primitive data types in below image.

![Primitive data types in java](https://howtodoinjava.com/wp-content/uploads/2015/05/Primitive-data-types-in-java.jpg)Primitive data types in java

## 1\. Java Integral Data Types
...
Character Escape SequenceDescription‘\\n’A linefeed‘\\r’A carriage return‘\\f’A form feed‘\\b’A backspace‘\\t’A tab‘\\\\’A backslash‘\\”‘A double quote‘\\”A single quote

These are only eight-character escape sequences in Java. You cannot define your character escape sequences.
...
## 2\. Java Floating-Point Data Types
...
![Floating-Point Numbers](https://howtodoinjava.com/wp-content/uploads/2015/05/IEEE-754-32-bit-Single-Precision-Floating-Point-Numbers.gif)IEEE-754 32-bit Single-Precision Floating-Point Numbers
...
The results of some of the operations on the float are not defined. These results are represented by a special value of the float data type called NaN (Not-a-Number).
...
One important point to note is that a *boolean variable cannot be cast to any other data type and vice versa*. Java does not specify the size of the boolean data type. Its size is left up to the JVM implementation. Typically, the value of a boolean data type is stored internally in a byte.
...
[Twitter](https://twitter.com/intent/tweet?text=Primitive%20Data%20Types%20in%20Java&url=https%253A%252F%252Fhowtodoinjava.com%252Fjava%252Fbasics%252Fprimitive-data-types-in-java%252F&via=howtodoinjava&related=howtodoinjava)[Facebook](https://www.facebook.com/sharer/sharer.php?u=https%253A%252F%252Fhowtodoinjava.com%252Fjava%252Fbasics%252Fprimitive-data-types-in-java%252F)[LinkedIn](https://www.linkedin.com/shareArticle?mini=1&url=https%253A%252F%252Fhowtodoinjava.com%252Fjava%252Fbasics%252Fprimitive-data-types-in-java%252F&title=Java%20Primitive%20Data%20Types&source=https%253A%252F%252Fhowtodoinjava.com)[Reddit](https://www.reddit.com/submit?url=https%253A%252F%252Fhowtodoinjava.com%252Fjava%252Fbasics%252Fprimitive-data-types-in-java%252F)[Pocket](https://getpocket.com/save?url=https%253A%252F%252Fhowtodoinjava.com%252Fjava%252Fbasics%252Fprimitive-data-types-in-java%252F&title=Java%20Primitive%20Data%20Types)
